			...
			<div class="modal-body">
				<!-- main form -->
					...
					<input type="hidden" id="iID">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="serialNumber-update">Color:</label>
					    <div class="col-sm-9"> 
					   ...
					   <div class="form-group">
					    <label class="control-label col-sm-3" for="modelNumber-update">Make:</label>
					    <div class="col-sm-9"> 
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="brand-update">Model:</label>
					    <div class="col-sm-9"> 
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="amount-update">Owner:</label>
					    <div class="col-sm-9"> 
