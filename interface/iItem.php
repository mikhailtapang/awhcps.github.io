...
interface iItem{
	...
	public function insert_violation($account_number, $owner, $driver_name, $plate_number, $date_apprehended, $violation_officer, $violation_number, $violation, $iID, $status);
